...
// 자전거가 5개 이하인 정류장 이름 출력하기
//슈도코드 작성
// parkingBikeToCnt가 5개 이하인지 확인
// 5개 이하면 stationName 출력
...
for(let i=0; i<bikes.length; i++){
  if(bikes[i]['parkingBikeTotCnt']<=num){
    console.log('자전거 대수가 '+num+'개 이하인 정류장 '+bikes[i]['stationName']);
  }
}
}
show_name(10);
